main()
{
	...
	{
		level.radio = [];
		level.radio[0] = spawn("script_model", (6707, 4655, 5));
		...
		level.radio[9] = spawn("script_model", (3928, 3868, 49));
		...
		level.radio[11] = spawn("script_model", (4411, 5272, 16));
		...
		level.radio[13] = spawn("script_model", (3503, 5375, 55));

...
Load()
{
	game["rules_leagueString"] = &"Team Deathmatch";
...
{
    	// Match Style
	arr = ruleCvarDefault(arr, "scr_tdm_timelimit", 15);		// Time limit. When halftime is enabled, its time limit per half. 0=disabled (minutes)
	...
	arr = ruleCvarDefault(arr, "scr_tdm_strat_time", 3);			// Strat time

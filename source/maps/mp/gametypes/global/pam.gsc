...
init()
{
	...
	if(game["firstInit"])
	{
		...
		precacheString2("STRING_PAM_MUST_EXISTS_UNDER_MAIN", &"Iwd file ^9zpam408_na.iwd^7 must be installed in ^9main^7 folder."); // ZPAM_RENAME
	...
	level.pam_folder = "main/zpam408_na"; // ZPAM_RENAME
...
*/
	...
	blackList[blackList.size] = "zpam408";
